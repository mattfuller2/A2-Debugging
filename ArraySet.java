...
public class ArraySet<T> implements SimpleSet<T> {
	...
	private T[] setArray; // holds current elements of the set in consecutive indexes beginning with
	                      // 0
	private int rear; // the next open index where a new element could be added, also the size of
	                  // the set
