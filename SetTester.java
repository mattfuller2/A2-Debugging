...
/**
 * A unit test class for implementations of the SimpleSet ADT. This is a set of black box tests thatswd
...
public class SetTester {
	 ...
	 */
	private SimpleSet<Integer> A_removeA_emptySet()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
	 ...
	 */
	private SimpleSet<Integer> AB_removeA_B()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
		set.add(ELEMENT_B);
	 ...
	 */
	private SimpleSet<Integer> AB_removeB_A()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
		set.add(ELEMENT_B);
	 ...
	 */
	private SimpleSet<Integer> ABC_removeA_BC()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
		set.add(ELEMENT_B);
	 ...
	 */
	private SimpleSet<Integer> ABC_removeB_AC()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
		set.add(ELEMENT_B);
	 ...
	 */
	private SimpleSet<Integer> ABC_removeC_AB()
	{
		SimpleSet<Integer> set = emptySet();
		set.add(ELEMENT_A);
		set.add(ELEMENT_B);
